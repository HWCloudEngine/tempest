...
class VolumesV2TransfersTest(base.BaseVolumeTest):
    ...
    def test_create_get_list_accept_volume_transfer(self):
        ...
        waiters.wait_for_volume_status(self.client, volume['id'], 'awaiting-transfer')
        ...
        waiters.wait_for_volume_status(self.alt_client, volume['id'], 'available')
