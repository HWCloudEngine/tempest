...
class VolumesV2ActionsTest(base.BaseVolumeTest):
    ...
    def test_attach_detach_volume_to_instance(self):
        ...
        waiters.wait_for_volume_status(cls.client, self.volume['id'], 'in-use')
        self.client.detach_volume(self.volume['id'])
        waiters.wait_for_volume_status(cls.client, self.volume['id'], 'available')
    ...
    def test_get_volume_attachment(self):
        ...
        self.client.attach_volume(self.volume['id'],
                                  instance_uuid=self.server['id'],
                                  mountpoint=mountpoint)
        waiters.wait_for_volume_status(self.client, self.volume['id'], 'in-use')
